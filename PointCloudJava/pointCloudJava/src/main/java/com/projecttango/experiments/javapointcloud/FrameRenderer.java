...
import com.projecttango.experiments.javapointcloud.PointCloudActivity;
...
class FrameRenderer implements GLSurfaceView.Renderer {
    ...
    FrameRenderer(PointCloudActivity activity) {
        activity_ = activity;
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        Log.i(activity_.TAG, "onSurfaceChanged");
    }
